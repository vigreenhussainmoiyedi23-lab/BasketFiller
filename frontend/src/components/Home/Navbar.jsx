...
const Navbar = ({ navigate }) => {
    ...
    return (
        <nav className='flex justify-between rounded-b-4xl w-[90vw] m-auto text-2xl text-white bg-white/5 backdrop-blur-2xl items-center min-h-[10vh] max-h-max py-3 px-10 '>
            <div>
