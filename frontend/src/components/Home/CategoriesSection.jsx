...
const CategoriesSection = () => {
  ...
  return (
    <div className="w-full py-16 text-white bg-white/5 backdrop-blur-3xl">
      ...
      <div className="w-screen overflow-hidden relative flex  h-max min-h-15">
        <div className="text-3xl xl:text-5xl w-max absolute top-0 animate-linearLoop-smalldevices md:animate-linearLoop flex gap-10 ">
          {categouries.map(cat => {
